...
-- 지금까지 배운 문법으로 수도권(서울, 경기)에 사는 사람을 쿼리문 하나로 조히해주세요.
SELECT * FROM user_tbl WHERE user_address = '서울' OR user_address = '경기';

-- IN 문법은 IN다음에 오는 리스트 목록에 포함된 요소만 출력해줍니다.
SELECT * FROM user_tbl WHERE user_address IN ('서울', '경기');
 ...
 -- %는 와일드카드 문자로, 어떤 문자가 몇글자가 와도 좋다는 의미입니다.
...
-- AND를 이용해서도 동일한 조건의 쿼리문을 작성해주세요.
...
INSERT INTO user_tbl VALUES(null, '김혜경', 1992, '강원', null, '2020-10-02');
INSERT INTO user_tbl VALUES(null, '신지수', 1993, '서울', null, '2020-10-05');
