...
-- DELETE FROM을 이용해서 user_tbl2의 2020-08-25 이후 가입자를 삭제해보세요.
DELETE FROM user_tbl2 WHERE entry_date > '2020-08-25';

-- DLETE FROM을 이용해서 2020-08-03 에 가입한 유저만 지목해서 삭제하는 쿼리문을 작성해주세요.
...
-- 컬럼 이름을 바꿔서 조회고 싶다면, 컬럼명 AS 바꿀 이름 형식을 따라주시면 됩니다.
